...
-(NSDictionary *)getPropertyDictionary{
   ...
   [self enumerateSuperClasses:^(__unsafe_unretained Class c, BOOL *stop) {
       unsigned int outCount;
       objc_property_t * propertyes = class_copyPropertyList(c, &outCount);
...
-(void)enumerateSuperClasses:(void(^)(Class c,BOOL *stop))enumeration{
...
- (BOOL)isClassFromFoundation:(Class)c
{
    if (c == [NSObject class] || c == [NSManagedObject class] || c==[BaseObject class]) return YES;
